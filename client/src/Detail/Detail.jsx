                ...
                >
                  <div className="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0">
                    <img
                      className="w-100"
                      src={
                        !detail.img1?.includes("upload")
                          ? detail.img1
                          : `http://localhost:5000/${detail.img1}`
                      }
                      alt="..."
                    />
                  </div>
                  <div className="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0">
                    <img
                      className="w-100"
                      src={
                        !detail.img2?.includes("upload")
                          ? detail.img2
                          : `http://localhost:5000/${detail.img2}`
                      }
                      alt="..."
                    />
                  </div>
                  <div className="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0">
                    <img
                      className="w-100"
                      src={
                        !detail.img3?.includes("upload")
                          ? detail.img3
                          : `http://localhost:5000/${detail.img3}`
                      }
                      alt="..."
                    />
                  </div>
                  <div className="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0">
                    <img
                      className="w-100"
                      src={
                        !detail.img4?.includes("upload")
                          ? detail.img4
                          : `http://localhost:5000/${detail.img4}`
                      }
                      alt="..."
                    />
                  </div>
